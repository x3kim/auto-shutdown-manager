...
class WarningDialog(ctk.CTkToplevel):
    def __init__(self, parent, idle_monitor: IdleMonitor, loc: LocalizationManager, action_callback):
        ...
        # --- UI Elemente ---
        self.lbl_title = ctk.CTkLabel(self, text=self.loc.get("WARN_TITLE"), font=("Segoe UI", 22, "bold"), text_color="#ff5555")
        self.lbl_title.pack(pady=(20, 5))

        self.lbl_info = ctk.CTkLabel(self, text=self.loc.get("WARN_INFO"), font=("Segoe UI", 14))
        self.lbl_info.pack(pady=5)

        self.lbl_countdown = ctk.CTkLabel(self, text="60", font=("Segoe UI", 55, "bold"))
        ...
        # Cancel Button
        self.btn_cancel = ctk.CTkButton(self, text="CANCEL / ABBRECHEN", fg_color="#444", hover_color="#555", command=self.close_dialog)
